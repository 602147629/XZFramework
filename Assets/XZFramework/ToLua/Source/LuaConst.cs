...
{
    public static string luaDir = Application.dataPath + "/XZFramework/ToLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/XZLuaFramework/ToLua/ToLua/Lua";        //tolua lua文件目录
